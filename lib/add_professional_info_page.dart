...
class AddProfessionalInfoPage extends StatefulWidget {
  final Function onNext;
  final Function onBack;

  AddProfessionalInfoPage({required this.onNext, required this.onBack});

  @override
  _AddProfessionalInfoPageState createState() => _AddProfessionalInfoPageState();
}

class _AddProfessionalInfoPageState extends State<AddProfessionalInfoPage> {
